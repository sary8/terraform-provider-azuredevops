	...
	testCases := []struct {
		...
		},
		{
			...
			expectedReturn: map[string]string{
				...
				"projects.#":             "1",
				"projects.0.id":          (*processWithExpand.Projects)[0].Id.String(),
				"projects.0.name":        *(*processWithExpand.Projects)[0].Name,
				"projects.0.description": *(*processWithExpand.Projects)[0].Description,
				"projects.0.url":         *(*processWithExpand.Projects)[0].Url,
			},
		},
		{
			...
			expectedReturn: map[string]string{
				...
				"projects.#":             "1",
				"projects.0.id":          (*minimalProcessWithExpand.Projects)[0].Id.String(),
				"projects.0.name":        "",
